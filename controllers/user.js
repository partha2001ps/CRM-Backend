...
const usercontrollers = {
  ...
  sendResetEmail: (email, OTP, res) => {
    ...
    const link =`https://customers-crm.netlify.app/reset-password/new-password/${OTP}`;
  ...
  activetlikesent: async (req, res) => {
    ...
    if (user) {
      ...
      const activationLink = ` https://customers-crm.netlify.app/activate-account/${activationToken}`;
      const mailOptions = {
